# Generated by Powerlevel10k configuration wizard on 2025-06-07 at 16:14 JST.
...
# 2 lines, solid, no frame, lightest-ornaments, sparse, concise, transient_prompt,
...
() {
  ...
  typeset -g POWERLEVEL9K_TIME_FORMAT='%D{%H:%M:%S %Z}'  # This will show the timezone abbreviation
  typeset -g POWERLEVEL9K_TIME_COMMAND='TZ="Asia/Tokyo" date +%H:%M:%S'  # This sets the timezone to JST
  # If set to true, time will update when you hit enter. This way prompts for the past
  # Time in Japanese Standard Time (JST)   # 時間表示フォーマットを設定（24時間表示）
  export TZ="Asia/Tokyo"  # 日本時間に設定
